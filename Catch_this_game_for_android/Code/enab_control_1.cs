...
public class enab_control_1 : MonoBehaviour {

	// Use this for initialization
	void Start () {
        if ((PlayerPrefs.GetInt("enabled_0") == 0)
            && (PlayerPrefs.GetInt("enabled_1") == 1)
            && (PlayerPrefs.GetInt("enabled_2") == 0)
            && (PlayerPrefs.GetInt("enabled_3") == 0)
	...
	void Update () {
        if ((PlayerPrefs.GetInt("enabled_1") == 1) && ((PlayerPrefs.GetInt("enabled_0") == 1)
